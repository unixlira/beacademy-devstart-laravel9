<div class="w-auto bg-white shadow-md rounded px-8 py-12">
    ...
    <!-- <input type="file" name="image" class="block w-full text-sm text-slate-500
      ...
      <input type="text" name="image" placeholder="Insira uma url" value="{{ $user->inage ?? old('image') }}"class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline my-2">
